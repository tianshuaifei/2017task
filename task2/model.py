...
import task2.helper as helper
import task2.core_rnn_cell_impl as rnn_cell
from task2.Config import Config
import task2.TfUtils as TfUtils
args=None

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="training options")

    parser.add_argument('--load-config', action='store_true', dest='load_config', default=True)
