...
class Config(object):
    ...
    """
    """General"""
    train_data='./data/char/train.txt'
    val_data='./data/char/dev.txt'
    test_data='./data/char/test.txt'
    vocab_path='./data/char/vocab.txt'
    id2tag_path='./data/char/id2tag.txt'
    embed_path='./data/embed/embedding.'
